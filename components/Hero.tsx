    ...
    <section id="home" className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          {/* Main Headline */}
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight fade-in-up-delay-1 animate-float-subtle">
          ...
          {/* Description */}
          <p className="text-lg text-dark-300 mb-8 max-w-3xl mx-auto leading-relaxed fade-in-up-delay-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 fade-in-up-delay-3">
            <button className="relative overflow-hidden bg-gradient-to-r from-slate-100 via-white to-slate-100 hover:from-white hover:via-slate-50 hover:to-white text-black font-bold text-base px-7 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-slate-200/60 flex items-center space-x-2 group border border-slate-200/30 hover:border-slate-100/50">
