        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 border border-gray-200 shadow-sm">
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <p className="mb-3">Root News is an AI-powered news aggregation and summarization service available in two tiers:</p>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">Free Tier</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Full access to AI-powered news summaries across 10+ categories</li>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Root Pro (Premium Tier)</h3>
              <p className="mb-3">Everything in the free tier, plus:</p>
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Deep Dives</strong>: AI-powered deep dive presets on any article</li>
                <li><strong>Daily Briefing</strong>: Personalized daily news briefing in text and audio format</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li><strong>Free Tier</strong>: Available to all users with no subscription required for core news features</li>
                <li><strong>Monthly Subscription (Root Pro)</strong>: $4.99 per month</li>
                <li><strong>Annual Subscription (Root Pro)</strong>: $29.99 per year</li>
                <li>All paid subscriptions are processed through Apple App Store</li>
              </ul>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Premium Features and Usage Limits</h2>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.1 Deep Dive Presets</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Deep dive presets (Quick Catch-up, Why This Matters, Full Context, Both Sides) are AI-powered features available exclusively to Root Pro subscribers</li>
                <li>Usage limits may apply to ensure service quality</li>
                <li>Responses are generated by AI and may not always be fully accurate</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.2 Daily Briefing</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Daily Briefing is a personalized text summary generated once per day based on your selected news categories, available exclusively to Root Pro subscribers</li>
                <li>An audio version of the Daily Briefing is generated once per day using AI text-to-speech</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.3 Usage Limit Adjustments</h3>
              <p>We reserve the right to adjust usage limits at any time to maintain service quality and ensure a fair experience for all users.</p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. User Conduct and Restrictions</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 mb-3">6.1 Acceptable Use</h3>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Attempt to circumvent subscription requirements or usage limits</li>
                <li>Use deep dive features to generate content for commercial purposes</li>
                <li>Perform automated or bulk querying of deep dive features</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Third-Party Content and Services</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 mb-3">9.1 News Sources</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">9.2 Apple Services</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">10.2 Service Modifications</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">11. Content Accuracy and Disclaimers</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.1 AI-Generated Content</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.2 Deep Dive Responses</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Deep dive responses are AI-generated and may not be fully accurate or complete</li>
                <li>Responses should not be relied upon as professional, legal, medical, or financial advice</li>
                <li>Users should independently verify any information obtained through deep dive features</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.3 Daily Briefing and Audio</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Daily Briefing summaries are AI-generated from the day's top stories and may contain inaccuracies</li>
                <li>Audio briefings are produced using AI-generated speech and may occasionally mispronounce names, places, or specialized terms</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.4 Neutrality and Bias</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Root News strives for neutral, unbiased reporting in all AI-generated content</li>
                <li>AI systems may inadvertently reflect biases present in training data or source material</li>
                <li>We continuously work to identify and reduce bias in our AI outputs</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.5 Content Updates</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">12.1 Service Disclaimer</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">12.2 Liability Limits</h3>
              <p className="mb-6 bg-gray-100 p-4 rounded-lg text-sm text-gray-900">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">12.3 Excluded Damages</h3>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">14.1 Termination by You</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">14.2 Termination by Us</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">14.3 Effect of Termination</h3>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">16.1 Governing Law</h3>
              <p className="mb-6">These Terms are governed by the laws of Estonia, without regard to conflict of law principles.</p>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">16.2 Dispute Resolution</h3>
              <p className="mb-6">Any disputes shall be resolved through binding arbitration in Estonia, except where prohibited by law.</p>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">16.3 Class Action Waiver</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">17. Apple App Store Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">21. Service Provider</h2>
              <div className="bg-gray-100 p-4 rounded-lg">
