          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Ask Root</strong>: AI-powered Q&A on any article</li>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">5.1 Ask Root</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Ask Root is an AI-powered Q&A feature available exclusively to Root Pro subscribers</li>
                <li>Usage is limited to 30 questions per day and 6 messages per article conversation</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Use Ask Root to generate content for commercial purposes</li>
                <li>Perform automated or bulk querying of the Ask Root feature</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">11.2 Ask Root Responses</h3>
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>Ask Root responses are AI-generated and may not be fully accurate or complete</li>
                <li>Responses should not be relied upon as professional, legal, medical, or financial advice</li>
                <li>Users should independently verify any information obtained through Ask Root</li>
              </ul>
